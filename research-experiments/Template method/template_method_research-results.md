...
**Záver:** **Silný pokrok.** CALLS filter odstránil **54 FP** (z 145 na 91) bez straty TP. Recall zostáva 0.900, precision stúpla z 0.062 na 0.099. Dôležité pozorovanie: **CALLS filter funguje spoľahlivo** — na rozdiel od Decoratora, kde sme potrebovali upravu v client.js kvôli JDT resolúcii na konkrétnu implementáciu, tu template method volá `this.primitiveOp()` priamo na abstract metódu v tej istej triede a JDT to správne zachytí.
